...
```
Add Migration: Add-Migration DropDeviceIdGlobalUnique  -Context CleansiaDbContext -Project '03 Infrastructure\Cleansia.Infra.Database' -StartupProject '05 Web\Cleansia.Web.Partner'
