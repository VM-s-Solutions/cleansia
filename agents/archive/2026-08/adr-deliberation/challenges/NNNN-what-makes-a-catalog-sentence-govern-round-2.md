...
`agents/archive/2026-08/adr-deliberation/drafts/NNNN-what-makes-a-catalog-sentence-govern-round-2.md` (`proposed`).
...
> `.claude/agents/reviewer.md`, `agents/archive/2026-08/adr-deliberation/challenges/0033-floor.md`, the ticket directory,
> the ADR directory).
>
...
6. **The arithmetic is clean and the procedural discipline is right.** 9 + 3 + 1 = 13; 12 scored, R10
   excluded. **No number allocated** — I globbed `docs/decisions/00*.md` and the highest on disk is
