...
- **T-0484** — customer order-detail redesign. Produces **2–3 HTML concepts** at
  `agents/archive/2026-08/backlog/attachments/`, each with all six order statuses and a **per-platform S/M/L
...
> **Provenance.** ADR-0041's §Escalations opens *"Filed as one block in `agents/archive/2026-08/backlog/questions/open.md`
