...
HTML under `agents/archive/2026-08/backlog/attachments/`. `git diff --stat -- src/` **must be empty** for both.
...
`agents/archive/2026-08/backlog/tickets/` for dedup (T-0211, T-0242 `done`, T-0511) and `agents/archive/2026-08/backlog/audits/`.
...
- **Did not write outside `agents/archive/2026-08/backlog/**`.** Not `agents/knowledge/**`, not `docs/decisions/**`
...
- **`agents/tools/check-ticket-staleness.mjs`** — **~200 lines** plus a **~120-line `.test.mjs`**, matching
  ...
  **this pass specified it rather than building it** — and building it would also have written outside this
  pass's `agents/archive/2026-08/backlog/**` boundary.
...
- **Did not write outside `agents/archive/2026-08/backlog/**`.** Not `agents/knowledge/**`, not `docs/decisions/**`, not
