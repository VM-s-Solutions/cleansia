...
`agents/archive/2026-08/backlog/audits/AUDIT-2026-06-01-findings.md:80`, slice report
`agents/archive/2026-08/backlog/audits/AUDIT-2026-06-01-slice-reports.md:1598-1604`, JSON entry
`AUDIT-2026-06-01-findings.json:3` (id `PERF-IDA-01`), plan/map row
`agents/archive/2026-08/backlog/TICKET-MAP.md:56`.
...
- **Serialization cluster:** **none.** The only file this ticket edits is
  ...
  appear in any cluster in `agents/archive/2026-08/backlog/TICKET-MAP.md`. Safe to run concurrently with other Wave-0
