...
`agents/archive/2026-08/backlog/audits/AUDIT-2026-06-01-findings.json` (id `BLIND-5`) and the slice report
`agents/archive/2026-08/backlog/audits/AUDIT-2026-06-01-slice-reports.md:2419-2427`. The desired pattern already
...
- **Serialization cluster:** Not in any shared-file cluster in `agents/archive/2026-08/backlog/TICKET-MAP.md`.
