...
`agents/archive/2026-08/backlog/audits/AUDIT-2026-06-01-findings.md:59-60` — *"email sent inline & synchronously on the
critical path; a SendGrid outage hard-fails registration and password-reset."* Tracked in
`agents/archive/2026-08/backlog/INDEX.md:45` (BLIND-1, crit, ADR-INTEGRATION).
