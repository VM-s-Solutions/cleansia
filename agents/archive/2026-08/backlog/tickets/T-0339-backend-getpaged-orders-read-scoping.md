...
manual_steps: []
sprint: 12
source: T-0307 security gate (agents/archive/2026-08/backlog/security/ios-orders.md, DECISION 2b)
---
...
- 2026-06-27 — filed from the T-0307 security gate (DECISION 2b). Full S1–S10 walk + the binding iOS client
  rules (O1–O4) are in `agents/archive/2026-08/backlog/security/ios-orders.md`; the §7.8 sprint sub-note records it. High
