...
Searched `agents/archive/2026-08/backlog/tickets/` for `AM-B`, for the ruling's own words (*"notified of the price
change"*, *"non-member price"*) and for every filename matching `recur`/`notif`. The only file in
`agents/archive/2026-08/backlog/tickets/` that matches any of them is **T-0494 itself**. ADR-0036 AM-B
