...
- [x] **AC6 — a row is added to `agents/archive/2026-08/backlog/ios-app-review-checklist.md`** so this cannot be
...
`agents/archive/2026-08/backlog/ios-app-review-checklist.md`, and **T-0507**.
