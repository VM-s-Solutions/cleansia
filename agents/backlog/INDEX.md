...
| T-0688 | Multicurrency has never run at a rate other than 1, and CreateOrder accepts any currency id | L | `todo` | — | **researched + designed 2026-09-08 → [`research`](T-0688-multicurrency-research.md) · [`design + plan`](T-0688-multicurrency-design.md)**. All 8 owner decisions answered; target system and a 7-wave plan written. Scope is now CZ→SK→PL across three VAT jurisdictions — **must be split into tickets before anyone picks it up** |
