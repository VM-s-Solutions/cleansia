...
| T-0669 | Home: one title system (headings `Sky700`), neutral shadows, hero bubbles + wave + uniform scroll-fade removed | M | `in_progress` | — | PARTIAL: AC1/AC2/AC3 fail in SCSS - two heading colours, resting coloured shadow, orphaned bubble block |
