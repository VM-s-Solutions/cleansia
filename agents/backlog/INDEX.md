...
| T-0688 | Multicurrency has never run at a rate other than 1, and CreateOrder accepts any currency id | M | `todo` | — | **researched 2026-09-08 → [`T-0688-multicurrency-research.md`](T-0688-multicurrency-research.md)** — owner wants CZK+EUR at launch; two decisions block the code, and four findings fall outside this ticket. Size confirmed wrong |
