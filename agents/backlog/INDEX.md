...
| T-0688 | Multicurrency has never run at a rate other than 1, and CreateOrder accepts any currency id | M | `todo` | — | **LIVE PLAN → [`cz-only`](T-0688-multicurrency-plan-cz-only.md)**; background in [`research`](T-0688-multicurrency-research.md) and [`design`](T-0688-multicurrency-design.md). SK/PL out of scope by owner ruling, so 18 steps became 9 and 7 waves became 3. VAT convention fix already shipped (56ad4d45) |
