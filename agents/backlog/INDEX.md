...
| T-0685 | GDPR retention sweep has never run in production - an absent feature flag reads as disabled | S | `in_progress` | — | switch moved to config (`DataRetention:Enabled`, default true); code complete + green. Gated on the PRO address-exposure count before it ships |
