...
the living doc. Target: `agents/backlog/adr/drafts/NNNN-client-price-display-splits-the-server-total.md`
...
write, no ADR edit, nothing outside `agents/backlog/adr/challenges/`.
