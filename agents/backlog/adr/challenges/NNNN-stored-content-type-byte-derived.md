...
- **`agents/backlog/adr/challenges/0044-stored-content-type-byte-derived.md`** — this challenge.
- **`agents/backlog/adr/0044-stored-content-type-is-byte-derived-on-every-intake.md`** — the ADR it
