...
- [ ] **AC2 (Gate-DP §G hardening — the architect is folding this in)** —
...
- [ ] **AC3 (applies to this phase)** — Every phase/ios-fix1 slice (T-0368, T-0369, T-0370's iOS surface,
  T-0371, T-0372, T-0373) carries iOS 16.4 smoke evidence in its ticket before the phase exits; the phase's
  Definition-of-Done references this leg.
