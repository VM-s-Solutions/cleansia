...
- Historical records — `agents/backlog/audits/*`, `agents/backlog/status/sprint-*`,
  `agents/backlog/security/*`, and closed tickets' `## Review` sections. Each says what was walked **on
