...
- **The OrderDetail sheet** is the **custom non-modal `SnapSheet` Core container** (`GeometryReader`+`DragGesture`, 3
  ...
  the size↔detent feedback loop). No trailing `Spacer()`.
