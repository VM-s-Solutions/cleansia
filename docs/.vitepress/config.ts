        ...
        '/decisions/': [
          {
            ...
            items: [
              ...
              { text: "ADR-0056 — Property size is two integers; the label is per-country…", link: '/decisions/adr-0056' },
              { text: "ADR-0057 — Confirmed means a cleaner took the job, and nothing else", link: '/decisions/adr-0057' },
        ...
        '/api/': [
          {
            ...
            items: [
              ...
              { text: 'Markets and memberships', link: '/api/markets-and-memberships' },
