---
title: ADR-0007 — Soft delete policy
adr: ADR-0007
status: accepted
---
...
**S10 is the load-bearing read rule** (`docs/architecture/security-rules.md:161-168`):
...
GDPR-boundary clarification; `docs/architecture/security-rules.md §S10` cross-references ADR-0007 (the
