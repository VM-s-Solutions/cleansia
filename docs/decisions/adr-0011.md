---
title: ADR-0011 — Mobile apiresult contract
adr: ADR-0011
status: accepted
---
...
- **T-0197 AC3–AC7 (serial children):** one customer-app repo + its VMs per child, characterization-green →
  ...
  `agents/archive/2026-08/backlog/audits/consistency-violations.md`.
...
Role files in `docs/domain/roles/` (CRC cards — added when the consumer tickets land so they reflect the
moved code):
