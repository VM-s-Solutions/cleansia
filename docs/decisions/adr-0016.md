---
title: ADR-0016 — Apple app review compliance and ios quality bar
adr: ADR-0016
status: accepted
---
...
- **Ticket:** IOS-COMPLIANCE-ADR (this ADR) · **Consumers:** new tickets appended to the Wave-10 iOS plan
  ...
  section) + the pre-submission audit artifact `agents/archive/2026-08/backlog/ios-app-review-checklist.md`.
...
> iOS ticket; and (4) a **pre-submission audit artifact** (`agents/archive/2026-08/backlog/ios-app-review-checklist.md`) the
...
A checklist artifact lives at **`agents/archive/2026-08/backlog/ios-app-review-checklist.md`** — the single document the team
...
11. **The pre-submission audit is green.** `agents/archive/2026-08/backlog/ios-app-review-checklist.md` is fully checked per app
...
- The living companion `agents/architecture/decisions/ios-app-architecture.md` gains a compliance section; the
  pre-submission audit artifact `agents/archive/2026-08/backlog/ios-app-review-checklist.md` is created (D4).
