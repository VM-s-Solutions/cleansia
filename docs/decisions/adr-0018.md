---
title: ADR-0018 — Ios design parity principle
adr: ADR-0018
status: accepted
---
...
- **Ticket:** IOS-DESIGN-PARITY-ADR (this ADR) · **Consumers:** a one-line design-parity note on every iOS **screen/feature** ticket in `status/sprint-12.md` (the first vertical + each feature wave); the standing **Gate-DP** added to `agents/archive/2026-08/backlog/ios-app-review-checklist.md` (§G) + the sprint-12 reviewer-check #22; the living companion `architecture/decisions/ios-app-architecture.md` (design-parity section).
...
Recorded as §G of `agents/archive/2026-08/backlog/ios-app-review-checklist.md` (the standing iOS reviewer gate) + sprint-12
