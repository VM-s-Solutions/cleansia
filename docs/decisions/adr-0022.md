---
title: ADR-0022 — Ios shell single navigation stack pager and pill bar
adr: ADR-0022
status: accepted
---
...
bounding the class and recording the convention in `agents/archive/2026-08/backlog/adr/README.md`: an in-body
