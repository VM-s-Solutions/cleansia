---
title: ADR-0024 — Mobile access token ttl is the device revocation…
adr: ADR-0024
status: accepted
---
...
- No `docs/domain/roles/*` change — no new aggregate/service/adapter; the existing
...
**Confirmed catalog edit** (from "Living docs" below): `docs/architecture/security-rules.md` gains,
