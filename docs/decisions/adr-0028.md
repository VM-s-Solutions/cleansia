---
title: ADR-0028 — Multi tenant activation pack
adr: ADR-0028
status: accepted
---
...
- `docs/architecture/security-rules.md` — S8 gains: *"Anonymous requests acquire their tenant from
...
- `docs/domain/roles/tenant-host-registry.md` — **new CRC card**: resolves serving hosts to
...
*Appended per `agents/archive/2026-08/backlog/adr/README.md:9-12` (dated appended section). **Nothing above this line is
...
**Owner context added since.** Q-VS-03 (`agents/archive/2026-08/backlog/questions/open.md:2324-2337`) — *"we won't have
