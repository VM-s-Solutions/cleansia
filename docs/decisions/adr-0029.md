---
title: ADR-0029 — Ios live activity for in progress clean
adr: ADR-0029
status: accepted
---
...
- **NEW** `docs/domain/roles/apns-live-activity-client.md` — signs and delivers one
...
- **NEW** `docs/domain/roles/live-activity-token.md` — remembers where an order's live card
  (and a device's remote-start ability) is addressable; does NOT know alert tokens, notification
  preferences, or payload content.
- **NEW** `docs/domain/roles/send-live-activity-update-handler.md` — translates one order
...
*(Bounded amendment per `agents/archive/2026-08/backlog/adr/README.md` §"Dated appended sections". The decision body
...
*(Bounded amendment per `agents/archive/2026-08/backlog/adr/README.md` §"Dated appended sections". D4's additive-only
