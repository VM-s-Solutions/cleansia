---
title: ADR-0031 — Nswag regen drift is guarded at regen time
adr: ADR-0031
id: ADR-0031
...
# ADR-0031 — NSwag regen drift is PREVENTED at the regen command by an Angular typecheck of every app compilation unit, and merely ATTRIBUTED — not prevented — on every other path by the `master` push build; the generated members stay required
...
Escalated as **Q-CI-01** in `agents/archive/2026-08/backlog/questions/open.md`.
...
**Owner escalation:** **Q-CI-01** (`agents/archive/2026-08/backlog/questions/open.md`) — require PRs for `master`?
