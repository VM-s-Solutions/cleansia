---
title: ADR-0032 — Catalog law declarations require a named ci gate
adr: ADR-0032
status: accepted
---
...
- **Number note:** **0031 is taken** by `0031-nswag-regen-drift-is-guarded-at-regen-time.md`, which
  ...
  *[pointer, 2026-08-05 — **not an erratum**; signed by the dated closure appended at the end of this
  ...
  `agents/archive/2026-08/backlog/adr/0031-nswag-regen-drift-is-guarded-at-regen-time.md` is a tracked file on
...
2026-07-30 ruling (`agents/archive/2026-08/backlog/INDEX.md:177`; the durable `shared-file-lanes.md` row is routed
