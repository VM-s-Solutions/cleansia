...
- **Date:** 2026-08-02 (drafted `proposed` under a live outage; challenged 2026-08-03 —
  `agents/archive/2026-08/backlog/adr/challenges/0038-seam.md`, nine findings; **amended and accepted by the panel lead
...
> end). This ADR is **0038**. Re-check `agents/archive/2026-08/backlog/adr/` before claiming the next number — this is
...
2. **A mechanical anti-orphan check — in `Cleansia.Tests`, not in `check-consistency.mjs` (AM-7).**
   ...
   - every referenced `T-` id is present in `agents/archive/2026-08/backlog/INDEX.md` and is **open *and not blocked***
...
- **NEW** `docs/domain/roles/post-commit-effects.md` — `IPostCommitEffects` /
...
> Filed 2026-08-03 as `agents/archive/2026-08/backlog/adr/challenges/0038-seam.md` (single challenger, seam / interim /
