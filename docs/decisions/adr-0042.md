...
> `agents/archive/2026-08/backlog/questions/open.md:1250`, `agents/archive/2026-08/backlog/tickets/T-0557-…:54` — and creating a dangling
...
- **Answers:** **`Q-ENUM-01`** (`agents/archive/2026-08/backlog/questions/open.md:1225`) — *"Three generated clients each
...
- **The filename.** If accepted, rename to `0042-the-csharp-declaration-is-the-wire-enum-authority.md` **in
  ...
  `agents/archive/2026-08/backlog/questions/open.md:1250` and `agents/archive/2026-08/backlog/tickets/T-0557-…:54`. Renaming before that is
...
- **`agents/knowledge/patterns-frontend.md:820-822`'s cycle sentence is stale at HEAD** — an immediate
  ...
  *"then fails `nx test models`"* — which the `inputs` lane has since made **true**. That half needs
  nothing.)*
- **`agents/archive/2026-08/backlog/questions/open.md` `Q-ENUM-01`** is already correct at HEAD and needs no edit until
...
**Filed 2026-08-05 — `agents/archive/2026-08/backlog/adr/challenges/0042-generation.md` (`4dea53ef`).** One round on
...
- **CH-G6 — ticket ids.** `T-0546` is taken (`agents/archive/2026-08/backlog/tickets/T-0546-four-customer-libs-cannot-run-jest.md`)
...
- **`agents/archive/2026-08/backlog/questions/open.md` Q-ENUM-01 needs two corrections** (PM/author lane — I may not edit
