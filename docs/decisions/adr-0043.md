---
title: ADR-0043 — User artifact metadata is scrubbed at intake by…
adr: ADR-0043
status: accepted
---
...
`docs/architecture/security-rules.md`; this ADR does not edit it**:
...
**Q-ART-01 is already filed by the PM in `agents/archive/2026-08/backlog/questions/open.md`. It is not re-filed here.**
...
**`agents/archive/2026-08/backlog/adr/challenges/NNNN-user-artifact-content-policy-threat-model.md`** — challenger in
