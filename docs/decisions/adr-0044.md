---
title: ADR-0044 — Stored content type is byte derived on every intake
adr: ADR-0044
status: accepted
---
...
**`agents/archive/2026-08/backlog/adr/0044-stored-content-type-is-byte-derived-on-every-intake.md`**, status
...
12. **Landing.** Rename to `agents/archive/2026-08/backlog/adr/0044-stored-content-type-is-byte-derived-on-every-intake.md`,
