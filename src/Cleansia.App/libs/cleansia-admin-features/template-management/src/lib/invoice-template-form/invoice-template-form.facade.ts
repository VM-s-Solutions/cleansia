...
@Injectable()
export class InvoiceTemplateFormFacade {
  ...
  readonly template = signal<InvoiceTemplateDetailDto | null>(null);
  ...
  createTemplate(data: InvoiceTemplateFormData): void {
    this.saving.set(true);

    const command = new CreateInvoiceTemplateCommand({
  ...
  updateTemplate(templateId: string, data: InvoiceTemplateFormData): void {
    this.saving.set(true);

    const command = new UpdateInvoiceTemplateCommand({
