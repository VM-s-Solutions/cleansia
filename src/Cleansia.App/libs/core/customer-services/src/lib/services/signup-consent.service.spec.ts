...
describe('SignupConsentService', () => {
  ...
  it('grants exactly the two documents the signup tick names', () => {
    ...
    // The add direction of a regen: a new member would show up as a key.
  ...
  it('survives a storage that refuses to write', () => {
    ...
    expect(() => service.record('jan@example.com')).not.toThrow();
  ...
  it('survives a client that throws on the spot', () => {
    ...
    expect(() => service.flush('jan@example.com')).not.toThrow();
  });
});
