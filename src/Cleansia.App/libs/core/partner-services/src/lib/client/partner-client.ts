...
export class AuthClient implements IAuthClient {
    ...
    protected processRegisterEmployee(response: HttpResponseBase): Observable<void> {
...
export interface IEmployeeClient {
     ...
     * @return OK
     */
    getMyPayoutDetails(query?: GetMyPayoutDetailsQuery | undefined): Observable<MyPayoutDetails>;
    /**
     * @param body (optional) 
     * @return OK
     */
...
export class EmployeeClient implements IEmployeeClient {
     ...
     */
    updateBankDetails(body?: UpdateBankDetailsCommand | undefined): Observable<UpdateBankDetailsResponse> {
        let url = this.baseUrl + "/api/Employee/UpdateBankDetails";
        url = url.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url, options).pipe(ObservableMergeMap((response : any) => {
            return this.processUpdateBankDetails(response);
        })).pipe(ObservableCatch((response: any) => {
            if (response instanceof HttpResponseBase) {
                try {
                    return this.processUpdateBankDetails(response as any);
                } catch (e) {
                    return ObservableThrow(e) as any as Observable<UpdateBankDetailsResponse>;
                }
            } else
                return ObservableThrow(response) as any as Observable<UpdateBankDetailsResponse>;
        }));
    }

    protected processUpdateBankDetails(response: HttpResponseBase): Observable<UpdateBankDetailsResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    getMyPayoutDetails(query?: GetMyPayoutDetailsQuery | undefined): Observable<MyPayoutDetails> {
        let url = this.baseUrl + "/api/Employee/GetMyPayoutDetails?";
        if (query === null)
            throw new globalThis.Error("The parameter 'query' cannot be null.");
        else if (query !== undefined)
            url += "query=" + encodeURIComponent("" + query) + "&";
        ...
        return this.http.request("get", url, options).pipe(ObservableMergeMap((response : any) => {
            return this.processGetMyPayoutDetails(response);
        })).pipe(ObservableCatch((response: any) => {
            if (response instanceof HttpResponseBase) {
                try {
                    return this.processGetMyPayoutDetails(response as any);
                } catch (e) {
                    return ObservableThrow(e) as any as Observable<MyPayoutDetails>;
                }
            } else
                return ObservableThrow(response) as any as Observable<MyPayoutDetails>;
        }));
    }

    protected processGetMyPayoutDetails(response: HttpResponseBase): Observable<MyPayoutDetails> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = ResponseText === "" ? null : JSON.parse(ResponseText, this.jsonParseReviver);
            result200 = MyPayoutDetails.fromJS(resultData200);
            return ObservableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(ObservableMergeMap((ResponseText: string) => {
...
export interface IOrderClient {
     ...
     * @return OK
     */
    getWorkContractPreview(orderId?: string | undefined, language?: string | undefined): Observable<WorkContractDto>;
    /**
     * @param body (optional) 
     * @return OK
     */
    acceptWorkContract(body?: AcceptWorkContractCommand | undefined): Observable<AcceptWorkContractResponse>;
    /**
...
export class OrderClient implements IOrderClient {
     ...
     */
    getWorkContractPreview(orderId?: string | undefined, language?: string | undefined): Observable<WorkContractDto> {
        let url = this.baseUrl + "/api/Order/GetWorkContractPreview?";
        if (orderId === null)
            throw new globalThis.Error("The parameter 'orderId' cannot be null.");
        else if (orderId !== undefined)
            url += "OrderId=" + encodeURIComponent("" + orderId) + "&";
        ...
        return this.http.request("get", url, options).pipe(ObservableMergeMap((response : any) => {
            return this.processGetWorkContractPreview(response);
        })).pipe(ObservableCatch((response: any) => {
            if (response instanceof HttpResponseBase) {
                try {
                    return this.processGetWorkContractPreview(response as any);
                } catch (e) {
    ...
    protected processGetWorkContractPreview(response: HttpResponseBase): Observable<WorkContractDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    acceptWorkContract(body?: AcceptWorkContractCommand | undefined): Observable<AcceptWorkContractResponse> {
        let url = this.baseUrl + "/api/Order/AcceptWorkContract";
        url = url.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url, options).pipe(ObservableMergeMap((response : any) => {
            return this.processAcceptWorkContract(response);
        })).pipe(ObservableCatch((response: any) => {
            if (response instanceof HttpResponseBase) {
                try {
                    return this.processAcceptWorkContract(response as any);
                } catch (e) {
                    return ObservableThrow(e) as any as Observable<AcceptWorkContractResponse>;
                }
            } else
                return ObservableThrow(response) as any as Observable<AcceptWorkContractResponse>;
        }));
    }

    protected processAcceptWorkContract(response: HttpResponseBase): Observable<AcceptWorkContractResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = ResponseText === "" ? null : JSON.parse(ResponseText, this.jsonParseReviver);
            result200 = AcceptWorkContractResponse.fromJS(resultData200);
            return ObservableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(ObservableMergeMap((ResponseText: string) => {
...
export class AcceptWorkContractCommand implements IAcceptWorkContractCommand {
    ...
    constructor(data?: IAcceptWorkContractCommand) {
        if (data) {
    ...
    init(Data?: any) {
        if (Data) {
            ...
            this.acceptedWorkContractTextId = Data["acceptedWorkContractTextId"];
        }
    }

    static fromJS(data: any): AcceptWorkContractCommand {
        data = typeof data === 'object' ? data : {};
        let result = new AcceptWorkContractCommand();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["acceptedWorkContractTextId"] = this.acceptedWorkContractTextId;
        return data;
    }
}

export interface IAcceptWorkContractCommand {
    orderId: string | undefined;
    acceptedWorkContractTextId: string | undefined;
}

export class AcceptWorkContractResponse implements IAcceptWorkContractResponse {
    orderId!: string | undefined;
    acceptanceId!: string | undefined;
    acceptedOn!: Date;
    documentVersion!: string | undefined;

    constructor(data?: IAcceptWorkContractResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): AcceptWorkContractResponse {
        data = typeof data === 'object' ? data : {};
        let result = new AcceptWorkContractResponse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["orderId"] = this.orderId;
        data["acceptanceId"] = this.acceptanceId;
...
export interface IAcceptWorkContractResponse {
    orderId: string | undefined;
    acceptanceId: string | undefined;
    acceptedOn: Date;
    documentVersion: string | undefined;
...
export class GetMyPayoutDetailsQuery implements IGetMyPayoutDetailsQuery {

    constructor(data?: IGetMyPayoutDetailsQuery) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): GetMyPayoutDetailsQuery {
        data = typeof data === 'object' ? data : {};
        let result = new GetMyPayoutDetailsQuery();
        result.init(data);
        return result;
    }
...
export interface IGetMyPayoutDetailsQuery {
}
...
export class MyPayoutDetails implements IMyPayoutDetails {
    ...
    constructor(data?: IMyPayoutDetails) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): MyPayoutDetails {
        data = typeof data === 'object' ? data : {};
        let result = new MyPayoutDetails();
        result.init(data);
        return result;
    }
...
export interface IMyPayoutDetails {
    scheme: PayoutScheme;
    status: PayoutDetailsStatus;
    bankCountryId: string | undefined;
    currencyId: string | undefined;
...
export class UpdateBankDetailsCommand implements IUpdateBankDetailsCommand {
    ...
    static fromJS(data: any): UpdateBankDetailsCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateBankDetailsCommand();
        result.init(data);
        return result;
    }
...
export class UpdateBankDetailsResponse implements IUpdateBankDetailsResponse {
    ...
    constructor(data?: IUpdateBankDetailsResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpdateBankDetailsResponse {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateBankDetailsResponse();
        result.init(data);
        return result;
    }
