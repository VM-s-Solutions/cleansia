...
export class UserItem implements IUserItem {
    ...
    init(Data?: any) {
        if (Data) {
            ...
            this.profilePhoto = Data["profilePhoto"] ? BlobFile.fromJS(Data["profilePhoto"]) : undefined as any;
        }
    }
...
export class UpdateCurrentUserCommand implements IUpdateCurrentUserCommand {
    ...
    init(Data?: any) {
        if (Data) {
            ...
            this.phoneNumber = Data["phoneNumber"];
            this.birthDate = Data["birthDate"] ? new Date(Data["birthDate"].toString()) : undefined as any;
            this.photo = Data["photo"] ? BlobFile.fromJS(Data["photo"]) : undefined as any;
        }
    }
...
export class BlobFile implements IBlobFile {
    ...
    static fromJS(data: any): BlobFile {
        data = typeof data === 'object' ? data : {};
        let result = new BlobFile();
        result.init(data);
        return result;
    }
