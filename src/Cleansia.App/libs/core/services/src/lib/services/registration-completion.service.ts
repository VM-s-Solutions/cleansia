...
import { RegistrationCompletionStatus } from '../client';
...
export class RegistrationCompletionService {
   ...
   */
  checkRegistrationCompletion(employeeStatus: RegistrationCompletionStatus | null): RegistrationCompletionResult {
   ...
   */
  isRegistrationComplete(employeeStatus: RegistrationCompletionStatus | null): boolean {
