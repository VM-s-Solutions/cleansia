    ...
    public class Validator : AbstractValidator<Command>
    {
        ...
        public Validator(IPayPeriodRepository payPeriodRepository)
        {
            ...
            RuleFor(x => x.PayPeriodId)
                ...
                .WithMessage(BusinessErrorMessage.PayPeriodAlreadyPaid);
        ...
        private async Task<bool> NotPaidAsync(string payPeriodId, CancellationToken cancellationToken)
        {
        ...
        public async Task<BusinessResult<Response>> Handle(Command command, CancellationToken cancellationToken)
        {
            ...
            if (payPeriod!.Status == PayPeriodStatus.Paid)
            {
                return BusinessResult.Failure<Response>(new Error(
                    nameof(command.PayPeriodId), BusinessErrorMessage.PayPeriodAlreadyPaid));
            }
