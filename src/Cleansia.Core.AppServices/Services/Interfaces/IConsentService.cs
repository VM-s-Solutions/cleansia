...
public interface IConsentService
{
    ...
    /// than the customer documents (ADR-0041, ADR-0062 D4).
    /// </summary>
    Task<bool> TryGrantAsync(string userId, ConsentType consentType, LegalDocument? document, CancellationToken cancellationToken);
}
