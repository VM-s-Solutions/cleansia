...
/// Stripe payouts, and the alternative to expiry is a debt that sits on the books forever. Twelve
/// months from the customer's LAST movement, so a customer who books once a year never loses
/// anything.</para>
///
