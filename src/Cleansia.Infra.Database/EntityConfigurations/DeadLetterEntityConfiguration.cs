...
/// consumers. Inherits the <see cref="TenantAuditableEntityConfiguration{T,TKey}"/> base so it picks up
/// the Id/TenantId/audit columns, the TenantId index and the foreign key into Tenants (TenantId is
/// nullable here — a poison body may be unparseable so the tenant can be unknown).
/// </summary>
