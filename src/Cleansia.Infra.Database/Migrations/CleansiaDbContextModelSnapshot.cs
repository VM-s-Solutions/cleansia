...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.LiveActivities.LiveActivityToken", b =>
                {
                    ...
                    b.HasIndex("UserId", "DeviceId", "OrderId")
                        .IsUnique();

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("UserId", "DeviceId", "OrderId"), false);

                    b.ToTable("LiveActivityTokens", (string)null);
                });
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Loyalty.PromoCodeRedemption", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "PromoCodeId", "UserId", "SlotOrdinal"), false);
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Memberships.MembershipBenefitUsage", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
                    ...
                    b.HasIndex("TenantId", "UserId", "BenefitKind", "PeriodKey")
                        .HasDatabaseName("IX_MembershipBenefitUsages_Quota");

                    b.HasIndex("TenantId", "UserId", "BenefitKind", "PeriodKey", "SlotOrdinal")
                        .IsUnique()
                        .HasDatabaseName("IX_MembershipBenefitUsages_Slot")
                        .HasFilter("\"IsActive\" = TRUE");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "UserId", "BenefitKind", "PeriodKey", "SlotOrdinal"), false);

                    b.ToTable("MembershipBenefitUsages", (string)null);
                });
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Memberships.MembershipPlan", b =>
                {
                    ...
                    b.Property<int>("ExpressUpgradesPerMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Orders.ExtraPrice", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Orders.Order", b =>
                {
                    ...
                    b.Property<string>("CustomerApartment")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Orders.OrderExtra", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Orders.OrderService", b =>
                {
                    ...
                    b.Property<decimal>("UnitPerRoomPrice")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Services.ServicePrice", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Tenancy.Tenant", b =>
                {
                    ...
                    b.Property<string>("ArchiveManifestSha256")
                        .HasMaxLength(64)
                        .HasColumnType("character(64)");

                    b.Property<string>("ArchiveRequestedBy")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");

                    b.Property<DateTimeOffset?>("ArchiveRequestedOn")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateOnly?>("WindDownFrom")
                        .HasColumnType("date");

                    b.Property<DateTimeOffset?>("WindDownLastRunOn")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("WindDownRequestedBy")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");

                    b.Property<DateTimeOffset?>("WindDownRequestedOn")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTimeOffset?>("WindDownRunStartedOn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Users.Employee", b =>
                {
                    ...
                    b.Property<bool>("HasPayoutDetails")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Users.EmployeePayoutDetails", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
                    ...
                    b.Property<string>("BankCountryId")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)");
                    ...
                    b.Property<DateTime?>("LastRevealedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ProviderAccountRef")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("TenantId", "EmployeeId"), false);

                    b.ToTable("EmployeePayoutDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Memberships.MembershipBenefitUsage", b =>
                {
                    ...
                    b.HasOne("Cleansia.Core.Domain.Memberships.UserMembership", "UserMembership")
                        .WithMany()
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Orders.ExtraPrice", b =>
                {
                    ...
                    b.HasOne("Cleansia.Core.Domain.Orders.Extra", "Extra")
                        .WithMany()
            ...
            modelBuilder.Entity("Cleansia.Core.Domain.Users.EmployeePayoutDetails", b =>
                {
                    ...
                    b.HasOne("Cleansia.Core.Domain.Users.Employee", "Employee")
                        .WithOne("PayoutDetails")
                        .HasForeignKey("Cleansia.Core.Domain.Users.EmployeePayoutDetails", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
