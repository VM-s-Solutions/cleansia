...
/// <summary>
/// AC7 (ADR-0001 D1/D2) — the reassign permission is <c>AdminOnly</c>, fail-closed, and mapped. An
...
public class AdminReassignOrderPolicyTests
{
    ...
    [Fact]
    public void CanReassignOrder_Is_Mapped_AdminOnly()
    {
        Assert.Equal(PhysicalPolicy.AdminOnly, Policy.CanReassignOrder.ToPhysicalPolicy());
    }
