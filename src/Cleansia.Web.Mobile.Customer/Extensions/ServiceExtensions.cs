...
public static class ServiceExtensions
{
    ...
    public static IServiceCollection AddUserAuthorization(this IServiceCollection services)
    {
        services.AddAuthorizationBuilder()
            ...
            // Customer = authenticated user that is NOT Employee/Admin (no
            // dedicated role claim — the absence of those roles is what
            // makes someone a customer). Mirrors Customer Web's policy so
            // controllers gated with [Permission("CustomerOnly")] resolve.
