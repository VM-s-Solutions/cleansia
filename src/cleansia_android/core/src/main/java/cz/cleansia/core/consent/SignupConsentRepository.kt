 ...
 *
 * The customer registration issues no session — it returns a bare boolean and routes to
 ...
 * has named that same account in a token response. Only the customer app parks: the partner
 * app sends its tick on `RegisterEmployee` and never binds this.
 *
