...
import cz.cleansia.partner.api.client.CountryApi as GenCountryApi
import cz.cleansia.partner.api.client.ServiceCityApi as GenServiceCityApi
import cz.cleansia.partner.api.model.CountryListItem as GenCountryListItem
import cz.cleansia.partner.api.model.ServiceCityDto as GenServiceCityDto

/**
 * The partner half of the same source, kept in step deliberately. `ServiceAreaProvider` states the
 * contract this source has to keep: *"Null = the fetch failed and
...
class ServiceAreaWireTest {
    ...
    private suspend fun <T> serving(
        ...
        call: suspend (PartnerServiceAreaDataSource) -> T,
    ): T {
