...
private struct AddressReviewPane: View {
    ...
    /// Delegates to `AddressServiceability`, which the booking flow's own review pane now
    /// shares. The three-outcome reasoning that used to live here moved with the logic.
