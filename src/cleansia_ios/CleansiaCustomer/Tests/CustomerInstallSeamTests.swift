...
@MainActor
final class CustomerInstallSeamTests: XCTestCase {
    ...
    func testInstallMovesResponseProcessingOffTheMainQueue() throws {
        ...
        XCTAssertFalse(CleansiaCustomerApiAPI.apiResponseQueue === DispatchQueue.main)
    }
    ...
    @discardableResult
    private func makeInstalledContainer() throws -> CustomerAppContainer {
