...
extension L10n {
    ...
    enum DeleteAccount {
        static var rowTitle: String {
            localized("delete_account_row_title")
        }

        static var rowSummary: String {
            localized("delete_account_row_summary")
        }
        ...
        static var headline: String {
            localized("delete_account_headline")
        }

        static var body: String {
            localized("delete_account_body")
        }

        static var requestedHeadline: String {
            localized("delete_account_requested_headline")
        }

        static var requestedBody: String {
            localized("delete_account_requested_body")
        }

        static var requestedSnackbar: String {
            localized("delete_account_requested_snackbar")
        }
        ...
        static var keptLabel: String {
            localized("delete_account_kept_label")
        }

        static var keptInvoices: String {
            localized("delete_account_kept_invoices")
        }

        static var keptPay: String {
        ...
        static var errorBlockedByInvoice: String {
            localized("delete_account_error_blocked_by_invoice")
        }

        static var errorBlockedByOrder: String {
            localized("delete_account_error_blocked_by_order")
        }

        static var errorAlreadyPending: String {
            localized("delete_account_error_already_pending")
        }
    }
}
