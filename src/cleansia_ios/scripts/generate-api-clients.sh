...
SWIFT
  ...
  # Root-level, not Sources/ — swiftPackagePath: . puts everything at the package root and the
  # generated Package.swift declares path: "." to match.
...
echo "  ls CleansiaCustomerApi/Models | grep -i reviewtag"
